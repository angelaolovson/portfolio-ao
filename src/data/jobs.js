export default [
    {
        ...
        jobDescriptions:["Rebuild the website by transitioning from WordPress to Astro, using React and Tailwind CSS to create reusable components and improve performance; collaborate with the design team to implement clearer layouts and navigation.", "Improve mobile responsiveness by optimizing image loading."],
